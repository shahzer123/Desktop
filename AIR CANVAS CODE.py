...
#Giving different arrays to handle colour points of different colors
...
#initialize mediapipe using the below two lines
...
while ret:
    ...
    frame=cv2.rectangle(frame,(40,1),(140,65),(0,00),2)
    ...
    #frame=cv2.cvtColor(hsv,cv2.COLOR_HSV@BGR)
